...
#sudo ln -s ~/.dotfiles/wallpaper.jpg /System/Library/CoreServices/DefaultDesktop.jpg
...
defaults write NSGlobalDomain AppleLocale -string "en_CA@currency=AUD"
...
# Sort folders to the top of all file lists
...
# Remove old items from trash automatically
...
# Set the icon magnification of Dock items to 55 pixels
...
# Don’t show Mojave recents in the dock
...
#sudo ln -s /Applications/Xcode.app/Contents/Developer/Applications/Simulator.app /Applications/Simulator.app
